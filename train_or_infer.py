...
def prepare_data_from_tfds(data_path='data/valid.tfrecord', is_rollout=False, batch_size=2):#train
    import functools
...
if __name__ == '__main__':
    ...
    if device == 'cuda':
        simulator.cuda()
    train(simulator)
    #torch.save(simulator.state_dict(), "model_simulator.pth")
    #infer(simulator)